...
urlpatterns = [
    ...
    path('loan-req/remove/<int:pk>', views.loan_request_remove, name='loan-req-remove'),
    ...
    path('loan-offer/remove/<int:pk>', views.loan_offer_remove, name='loan-offer-remove'),
